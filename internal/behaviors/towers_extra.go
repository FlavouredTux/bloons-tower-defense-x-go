...
func applyTierUpgrade(inst *engine.Instance, g *engine.Game, costs []float64) int {
	...
	// close upgrade UI and deselect the tower so the range circle disappears.
...
func applyPathUpgrade(inst *engine.Instance, g *engine.Game) bool {
	...
	// deselect the tower so the range circle disappears.
	inst.Vars["select"] = 0.0
	g.GlobalVars["upgradeselect"] = 0.0
	g.GlobalVars["up"] = 0.0
	g.GlobalVars["tower"] = 0.0
...
func RegisterExtraTowerBehaviors(im *engine.InstanceManager) {
	...
	im.RegisterBehavior("Burst_Charge", func() engine.InstanceBehavior { return &ChargeProjBehavior{hitRadius: 12} })
	...
	im.RegisterBehavior("Super_Charge", func() engine.InstanceBehavior { return &BombBehavior{} })
	im.RegisterBehavior("Mega_Charge", func() engine.InstanceBehavior { return &BombBehavior{} })
	im.RegisterBehavior("Mega_Mega_Charge", func() engine.InstanceBehavior { return &BombBehavior{} })
